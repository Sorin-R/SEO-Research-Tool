...
import { getSerpProviders, updateSerpProvider } from '../services/api';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Manage which configured SERP APIs are allowed to run. API secrets stay on the server; this page shows only the env variable names.
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Turn configured providers on or off without removing their API keys.
            </p>
          </div>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left font-semibold text-gray-700">API Env</th>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-5">
            ...
            <ul className="mt-3 space-y-2 text-sm text-blue-800">
              ...
              <li>Not configured: add the env var on Hostinger first, then toggle it on here.</li>
            </ul>
          </div>
        </div>
      </div>
