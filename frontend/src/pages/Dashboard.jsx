...
export default function Dashboard() {
  ...
  const kpiValues = useMemo(() => {
    ...
    const backlinksScannedSources = Number(backlinksSummary?.scannedSources || 0);
    ...
    return {
      ...
      backlinksSubtitle: hasBacklinksData
        ? `${backlinksRefDomains} referring domains${backlinksScannedSources ? ` • ${backlinksScannedSources} sources scanned` : ''}`
        : null,
      backlinksBadge: hasBacklinksData ? 'Free crawler' : null,
      ...
      >
        <DashboardGrid>
          ...
          <KpiCard
            ...
            emptyMessage="No backlink snapshot yet. Click refresh to run free backlink scan."
          />
          <KpiCard
            title="SERP Coverage"
